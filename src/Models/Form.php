...
class Form extends Model
{
    ...
    public static $visibility_options = [
        ['id' => self::FORM_PUBLIC, 'name' => self::FORM_PUBLIC.' (available to all users)','tqdefault' => self::FORM_PUBLIC,'time' => self::FORM_PUBLIC],
        ['id' => self::FORM_PRIVATE, 'name' => self::FORM_PRIVATE.' (available to only logged in users)','tqdefault' => self::FORM_PRIVATE,'time' => self::FORM_PRIVATE],
    ];
    ...
    {
        return static::whereOr('user_id', $user->id)
