                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="tqdefault" type="text" class="form-control{{ $errors->has('tqdefault') ? ' is-invalid' : '' }}" name="tqdefault" value="{{ old('tqdefault') }}" required autofocus placeholder="Enter Tq Default">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="time" type="text" class="form-control{{ $errors->has('time') ? ' is-invalid' : '' }}" name="time" value="{{ old('time') }}" required autofocus placeholder="Enter Time">
